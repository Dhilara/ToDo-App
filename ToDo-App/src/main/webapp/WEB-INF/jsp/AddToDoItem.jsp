...
<body>
    ...
    <div class="container">
        ...
        <form:form action="/saveToDoItem" method="post" modelAttribute="todo">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="addedOn">Added On</label>
            		<div class="col-md-6">
            			<form:input type="date" path="addedOn" id="addedOn"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3" for="finishBy">Finish By</label>
					<div class="col-md-6">
						<form:input type="date" path="finishBy" id="finishBy"
						    class="form-control input-sm" required="required" />
					</div>
				</div>
			</div>
